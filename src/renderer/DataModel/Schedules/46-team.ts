/** Standard schedules for 46-team tournaments */
...
export const Sched46Teams10RoundsPlusF: StandardSchedule = {
  fullName: '46 Teams - Pools of 6 Teams, then Pools of 6 Teams with Parallel Top Pools',
