/** Standard schedules for 38-team tournaments */
...
export const Sched38Teams10RoundsPlusF: StandardSchedule = {
  fullName: '38 Teams - Pools of 6 Teams, then Pools of 6 Teams with Parallel Top Pools',
