/** Standard schedules for 41-team tournaments */
...
export const Sched41Teams10RoundsPlusF: StandardSchedule = {
  fullName: '41 Teams - Pools of 6 Teams, then Pools of 6 Teams with Parallel Top Pools',
  ...
  constructPhases: () => {
    ...
    snakeSeed(prelimPools, 1, 41);

    const playoffTopPools = makePoolSet(2, 6, 1, 'Championship ', []);
    const playoffLowerPools = makePlacementPools(5, 6, 2, 13, 41);
