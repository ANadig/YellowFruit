/** Standard schedules for 44-team tournaments */
...
export const Sched44Teams10RoundsPlusF: StandardSchedule = {
  fullName: '44 Teams - Pools of 6 Teams, then Pools of 6 Teams with Parallel Top Pools',
