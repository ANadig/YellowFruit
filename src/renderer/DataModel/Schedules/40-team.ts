/** Standard schedules for 40-team tournaments */
...
export const Sched40Teams10RoundsPlusF: StandardSchedule = {
  fullName: '40 Teams - Pools of 6 Teams, then Pools of 6 Teams with Parallel Top Pools',
