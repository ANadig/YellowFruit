/** Standard schedules for 47-team tournaments */
...
export const Sched47Teams10RoundsPlusF: StandardSchedule = {
  fullName: '47 Teams - Pools of 6 Teams, then Pools of 6 Teams with Parallel Top Pools',
  ...
  constructPhases: () => {
    ...
    snakeSeed(prelimPools, 1, 47);

    const playoffTopPools = makePoolSet(2, 6, 1, 'Championship ', []);
    const playoffLowerPools = makePlacementPools(6, 6, 2, 13, 47);
