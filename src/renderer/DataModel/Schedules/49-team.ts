/** Standard schedules for 49-team tournaments */
...
export const Sched49Teams10RoundsPlusF: StandardSchedule = {
  fullName: '49 Teams - Pools of 6 Teams, then Pools of 6 Teams with Parallel Top Pools',
