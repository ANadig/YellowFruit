/** Standard schedules for 52-team tournaments */
...
export const Sched52Teams10RoundsPlusF: StandardSchedule = {
  fullName: '52 Teams - Pools of 6 Teams, then Pools of 6 Teams with Parallel Top Pools',
