/** Standard schedules for 42-team tournaments */
...
export const Sched42Teams10RoundsPlusF: StandardSchedule = {
  fullName: '42 Teams - Pools of 6 Teams, then Pools of 6 Teams with Parallel Top Pools',
  ...
  constructPhases: () => {
    ...
    snakeSeed(prelimPools, 1, 42);

    const playoffTopPools = makePoolSet(2, 6, 1, 'Championship ', []);
    const playoffLowerPools = makePlacementPools(5, 6, 2, 13, 42);
