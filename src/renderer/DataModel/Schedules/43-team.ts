/** Standard schedules for 43-team tournaments */
...
export const Sched43Teams10RoundsPlusF: StandardSchedule = {
  fullName: '43 Teams - Pools of 6 Teams, then Pools of 6 Teams with Parallel Top Pools',
  ...
  constructPhases: () => {
    ...
    prelimPools[4].size = 5;
    snakeSeed(prelimPools, 1, 43);

    const playoffTopPools = makePoolSet(2, 6, 1, 'Championship ', []);
    let playoffLowerPools = [new Pool(6, 2, '13th Place', false, 13, 18)];
    playoffLowerPools = playoffLowerPools.concat(makePlacementPools(5, 5, 3, 19, 43));
