/** Standard schedules for 39-team tournaments */
...
export const Sched39Teams10RoundsPlusF: StandardSchedule = {
  fullName: '39 Teams - Pools of 6 Teams, then Pools of 6 Teams with Parallel Top Pools',
  ...
  constructPhases: () => {
    ...
    snakeSeed(prelimPools, 1, 39);

    const playoffTopPools = makePoolSet(2, 6, 1, 'Championship ', []);
    let playoffLowerPools = makePlacementPools(2, 6, 2, 13, 24);
    playoffLowerPools = playoffLowerPools.concat(makePlacementPools(3, 5, 4, 25, 39));
