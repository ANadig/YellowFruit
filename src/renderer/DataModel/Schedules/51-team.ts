/** Standard schedules for 51-team tournaments */
...
export const Sched51Teams10RoundsPlusF: StandardSchedule = {
  fullName: '51 Teams - Pools of 6 Teams, then Pools of 6 Teams with Parallel Top Pools',
  ...
  constructPhases: () => {
    ...
    snakeSeed(prelimPools, 1, 51);

    const playoffTopPools = makePoolSet(2, 6, 1, 'Championship ', []);
    let playoffLowerPools = makePlacementPools(4, 6, 2, 13, 36);
    playoffLowerPools = playoffLowerPools.concat(makePlacementPools(3, 5, 6, 37, 51));
